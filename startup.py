...
font = ('times', 16, 'bold')
title = Label(main, text='Startup Funding Data Analysis GUI with Aditi')
...
uploadButton = Button(main, text="Upload Kaggle Dataset with us", command=uploadDataset)
uploadButton.place(x=50, y=150)
uploadButton.config(font=font1)

cleanStepsButton = Button(main, text="Show Cleaning Steps with us", command=showCleaningSteps)
cleanStepsButton.place(x=50, y=250)
cleanStepsButton.config(font=font1)

cleanDataButton = Button(main, text="Clean Data with us", command=runcleandata)
cleanDataButton.place(x=50, y=350)
cleanDataButton.config(font=font1)

analyseButton = Button(main, text="Analyze Data with us", command=Dataanalyse)
analyseButton.place(x=50, y=450)
analyseButton.config(font=font1)

visualizeButton = Button(main, text="Visualize Insights with us", command=visualizeinsights)
visualizeButton.place(x=50, y=550)
visualizeButton.config(font=font1)

recommendButton = Button(main, text="Recommendations with us", command=showinsights)
